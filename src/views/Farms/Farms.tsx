  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn BIJU')
            :
          TranslateString(320, 'Stake LP tokens to earn BIJU')
        }
      </Heading>
      <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        Deposit Fee will be used to increase the value of Biju&apos;s Nests!
      </Heading>
