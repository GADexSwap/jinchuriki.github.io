...
const FarmedStakingCard = () => {
  ...
  return (
    ...
    <a href={mouseBuyURL} target="_blank" rel="noreferrer" className="buy-mouse-btn" >Buy BIJU</a>
      <CardBody>
        ...
        <Block>
          <Label>{TranslateString(544, 'BIJU to Harvest')}</Label>
          <CakeHarvestBalance earningsSum={earningsSum}/>
          <Label>~${(mousePrice * earningsSum).toFixed(2)}</Label>
        </Block>
        <Block>
          <Label>{TranslateString(546, 'BIJU in Wallet')}</Label>
        ...
        <Actions>
          {account ? (
            ...
            >
              {pendingTx
                ? TranslateString(548, 'Collecting BIJU')
